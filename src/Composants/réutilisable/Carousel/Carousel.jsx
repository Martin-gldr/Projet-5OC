...
import logo from '../../../assets/logo/fleche.svg'
import { useEffect, useRef, useState } from 'react'
import logos from '../../../assets/logo/flecheS.svg'
function Carousel(props) {
    ...
    return (
        <div className='image-view-box' ref={boxRef}>
            <button className={carouselPrev} onClick={prevImg}> <img className='desk' src={logo} alt="" /><img className='phone'src={logos} alt="" /></button>
            ...
            <button className={carouselNext} onClick={nextImg}> <img className='desk' src={logo} alt="" /><img className='phone' src={logos} alt="" /></button>
        </div>
